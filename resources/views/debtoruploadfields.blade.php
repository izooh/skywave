                          ...
                          <div class="panel-body">
                            <div class="row">
                              <div class="col-md-6 col-sm-12 col-xs-12 gutter">
                                            <form class="form-horizontal" method="POST" action="{{ route('debtor_import_process') }}">
                                                        {{ csrf_field() }}
                                                                ...
                                                                @foreach ($csv_data[0] as $key => $value)
                                                                    <td>
                                                                        <select name="fields[{{ $key }}]">
                                                                            @foreach (config('app.debtor_fields') as $debtor_fields)
                                                                                <option value="{{ (\Request::has('header')) ? $debtor_fields : $loop->index }}"
                                                                                    @if ($key === $debtor_fields) selected @endif>{{ $debtor_fields }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </td>
                                                                @endforeach
